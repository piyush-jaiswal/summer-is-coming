...
class TestBallot:
    ...
    def test_show_status(stdout_patch, southeros_ballot):
        southeros_ballot._round_count = 5

        ballot_kingdom, ballot_kingdom2, ballot_kingdom3, *other_kingdoms = (
            southeros_ballot._ballot_kingdoms
        )
        competitors = [ballot_kingdom, ballot_kingdom2, ballot_kingdom3]
        ballot_kingdom.kingdom._allies_received.add(other_kingdoms[0].kingdom)
        ballot_kingdom2.kingdom._allies_received.add(other_kingdoms[1].kingdom)

        southeros_ballot._competitors = deepcopy(competitors)
    ...
    @staticmethod
    def test_winner(southeros_ballot):
        TestBallot.test__settle_tie(southeros_ballot)

    @staticmethod
    def test_evaluate_competitors(southeros_ballot):
        ballot_kingdom, ballot_kingdom2, ballot_kingdom3, *other_kingdoms = (
            southeros_ballot._ballot_kingdoms
        )
    ...
    @staticmethod
    def test_commence(southeros_ballot):
        ballot_kingdom, ballot_kingdom2, ballot_kingdom3, *_ = (
            southeros_ballot._ballot_kingdoms
        )
        southeros_ballot._competitors = [
